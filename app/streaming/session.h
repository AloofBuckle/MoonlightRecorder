...
public:
    ...
    Q_PROPERTY(bool bitstreamPassthroughMode READ isBitstreamPassthroughMode CONSTANT)
    Q_PROPERTY(QString recordingSummary READ getRecordingSummary NOTIFY recordingInfoChanged)
    Q_PROPERTY(QString recordingOutputTarget READ getRecordingOutputTarget NOTIFY recordingInfoChanged)
    ...
    BitstreamMuxer* ensureBitstreamMuxer();
    BitstreamMuxer* getBitstreamMuxer() const
    {
    ...
    bool isBitstreamPassthroughMode() const;
    QString getRecordingSummary() const;
    QString getRecordingOutputTarget() const;
    void updateRecordingOverlayText(const char* text);
...
private:
    ...
    void execBitstreamPassthrough();
    void finishExec(SDL_Surface* iconSurface);
    ...
    static
    void arDecodeAndPlaySample(char* sampleData,
                               int sampleLength,
    ...
    QString m_RecordingOutputTarget;
    BitstreamMuxer* m_BitstreamMuxer;
