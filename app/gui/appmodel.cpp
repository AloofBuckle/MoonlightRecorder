...
{
    StreamingPreferences::get()->configureGuiRecordingPassthrough();
    return createSessionForVisibleApp(appIndex);
}

Session* AppModel::createBitstreamSessionForApp(int appIndex,
                                                ...
                                                bool enableYUV444)
{
    ...
    preferences->configureBitstreamPassthrough(outputTarget,
                                               ffmpegPath,
                                               ffmpegExtraArgs,
                                               width,
                                               height,
                                               fps,
                                               bitrateKbps,
                                               static_cast<StreamingPreferences::VideoCodecConfig>(videoCodecConfig),
                                               enableHdr,
                                               enableYUV444);
    return createSessionForVisibleApp(appIndex);
}

Session* AppModel::createSessionForVisibleApp(int appIndex)
{
