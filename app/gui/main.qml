...
ApplicationWindow {
    ...
    property bool recorderMode: true
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            NavigableToolButton {
                ...
                ToolTip.timeout: 3000
                ToolTip.visible: hovered
                ToolTip.text: qsTr("Add host manually") + (newPcShortcut.nativeText ? (" ("+newPcShortcut.nativeText+")") : "")
    ...
    NavigableDialog {
        id: addPcDialog
        property string label: qsTr("Enter the IP address or hostname of your recording host:")
