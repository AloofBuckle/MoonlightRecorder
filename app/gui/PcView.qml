...
CenteredGridView {
    ...
    objectName: qsTr("Recording Hosts")
    ...
    Row {
        ...
        Label {
            ...
            text: StreamingPreferences.enableMdns ? qsTr("Searching for recording hosts on your local network...")
                                                  : qsTr("Automatic host discovery is disabled. Add a host manually.")
            font.pointSize: 20
    ...
    delegate: NavigableItemDelegate {
        ...
        Loader {
            ...
            sourceComponent: NavigableMenu {
                ...
                MenuItem {
                    text: qsTr("Host Status: %1").arg(model.online ? qsTr("Online") : qsTr("Offline"))
                    font.bold: true
                    enabled: false
                }
                NavigableMenuItem {
