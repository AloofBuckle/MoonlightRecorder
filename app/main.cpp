...
LONG WINAPI UnhandledExceptionHandler(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    swprintf_s(dmpFileName, L"%ls\\MoonlightRecorder-%I64u.dmp",
...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("MoonlightRecorder Project");
    QCoreApplication::setOrganizationDomain("moonlightrecorder.local");
    QCoreApplication::setApplicationName("MoonlightRecorder");
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("MoonlightRecorder-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("MoonlightRecorder-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
    ...
    SDL_SetHint(SDL_HINT_AUDIO_DEVICE_APP_NAME, "MoonlightRecorder");
    SDL_SetHint(SDL_HINT_APP_NAME, "MoonlightRecorder");
